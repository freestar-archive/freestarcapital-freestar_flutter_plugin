...
class MrecBannerAd extends StatefulWidget {
  ...
  Future<dynamic> adsCallbackHandler(MethodCall methodCall) async {
    print("fsfp_tag: MrecBannerAd.dart. adsCallbackHandler. methodCall: " +
        methodCall.method +
        "] args: " +
        methodCall.arguments);

    if (bannerAdListener == null) {
      print("fsfp_tag: MrecBannerAd.dart. Listener is null. info: " +
          methodCall.method +
          " args: " +
          methodCall.arguments);
    }
  ...
  @override
  State<StatefulWidget> createState() => _MrecBannerAdViewState();
}

class _MrecBannerAdViewState extends State<MrecBannerAd> with WidgetsBindingObserver {

  @override
  void initState() {
    super.initState();
    print("fsfp_tag: MrecBannerAd.dart. initState");
  }
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      ...
      // widget is resumed
        print("fsfp_tag: MrecBannerAd.dart. AppLifecycleState.resumed");
        widget._channel!.invokeMethod('resumed');
        break;
      case AppLifecycleState.inactive:
      // widget is inactive
        print("fsfp_tag: MrecBannerAd.dart. AppLifecycleState.inactive");
        break;
      case AppLifecycleState.paused:
      // widget is paused
        print("fsfp_tag: MrecBannerAd.dart. AppLifecycleState.paused");
  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: 'plugins.freestar.ads/MrecBannerAd',
  ...
  void _onPlatformViewCreated(int id) {
    print("fsfp_tag: MrecBannerAd.dart. _onPlatformViewCreated: " + id.toString());
    widget._channel = new MethodChannel('plugins.freestar.ads/MrecBannerAd_$id');
